...
describe('EZHostSDK Paste', () => {
  ...
  describe('createPaste', () => {
    ...
    it('should handle Axios error with no response data', async () => {
      ...
      await expect(sdk.createPaste(testText)).rejects.toThrow(
        'Failed to create paste: Network timeout'
      );
    });
    ...
    it('should handle Axios error with empty response', async () => {
      ...
      await expect(sdk.createPaste(testText)).rejects.toThrow('Failed to create paste: ');
    });
    ...
    it('should handle non-Axios errors', async () => {
      ...
      await expect(sdk.createPaste(testText)).rejects.toBe(customError);
    });
